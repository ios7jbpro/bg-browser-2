...
public class YtfullscreenActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.ytfullscreen);
	...
	private void initializeLogic() {
		SketchwareUtil.showMessage(getApplicationContext(), "Press back to exit.");
