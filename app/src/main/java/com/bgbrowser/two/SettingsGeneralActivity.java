		...
		switch1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (switch1.isChecked()) {
					...
					SketchwareUtil.showMessage(getApplicationContext(), "Follow system has been turned off.");
				}
				else {
			...
			public void onClick(View _view) {
				if (settings.getString("debug", "").equals("1")) {
					...
					if (settings.getString("darkmode", "").equals("1")) {
						cardview8.setCardBackgroundColor(0xFF424242);
					}
					else {
						cardview8.setCardBackgroundColor(0xFFEEEEEE);
					}
