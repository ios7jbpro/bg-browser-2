...
public class QuittgwebActivity extends AppCompatActivity {
	...
	private SharedPreferences quittg;
	private SharedPreferences settings;
	
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.quittgweb);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		quittg = getSharedPreferences("quittg", Activity.MODE_PRIVATE);
		settings = getSharedPreferences("settings", Activity.MODE_PRIVATE);
		
		textview3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				quittg.edit().putString("quittg", "true").commit();
				finish();
			}
		});
	}
	...
	private void initializeLogic() {
		if (settings.getString("darkmode", "").equals("1")) {
			...
			_rippleRoundStroke(textview3, "#2196F3", "#FFFFFF", 360, 0, "#000000");
		}
	}
